...
model = AutoModel(model="fsmn-vad", device=device)
...
print(f"Chunk 大小: {chunk_size} ms")
print(f"Chunk 步长: {chunk_stride} 样本")
...
for i in range(total_chunk_num):
    ...
    if len(res[0]["value"]):
        ...
        print(f"Chunk {i+1}/{total_chunk_num}: {chunk_time*1000:.2f} ms - 无语音活动")
